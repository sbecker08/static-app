        ...
        <div className={styles.galleryCard}>      
            ...
            <div className={styles.bodySection}>
                <p className={styles.location}>
                    <Image src='/iconLocation.svg' width={12} height={17} /><span>{location}</span>
                </p>
                <p className={styles.detail}>
                    <Image src='/iconUnits.svg' width={12} height={17} /><span>{unitDetails}</span>
                </p>
                <p className={styles.capRate}>
                    <Image src='/iconCaprate.svg' width={12} height={17} /><span>{capRate}</span>
                </p>
